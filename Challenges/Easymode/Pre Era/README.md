# Pre Era Normal Mode Challenges
...
Tested at 10x effective health, works better with more

Use Immolation until enemies reach ~40% health, then use Firestorm. Repeat

Spam Neutral Response

`Import Code`
```
TY7RCsIwDEV/RfZu30SwnyI+dN3dDKTpSDpliP9u5xzuLfckh5tX0/KEUUmKNZfDtYnn48nbCGbXk8JK1vTLlFLmUCiL7/Mk3Xd0gwahgj3qKKQsnVcMEOgKFYv7QKVGVoJEODASpATe2yloy/B2J3DnJqmOWj1Zn6j2mMXgBFPRipeGYXZtMIpb2BdvrOf8/O/jHJlkaG7vDw==
```
---
**C6**
...
Tested at 2116x effective health with no wave skip

Tested at 4.159e6x effective health with wave software

Spam Something on the enemies

Granite Foundation and Earth+Air Shell should be kept at a 2:1 ratio, Keep Nature and Water Shells at a 1:3 ratio with Earth+Air Shell.
...
`Import Code`
```
TZDNDoIwEIRfxXC3VxP7KMbDUoaySdmSdhGN8d0FBOztm9nN7M+7qsOIIbForq6nW+Uu54FYLATJv0xNmd0uEvxCpByPhjbEySo3MAu0cZRmrRufSFhhc4cQDHHaCJS023gixe4L6ZhgPbdqogNJGdYw9VEam5A5K4mDQUAPUQqluYUUzjK4kL+JZcy6Dp6uI/F7/ZBH3v/w+Qthhsd82bDsnWMP7Vh8df98AQ==
```
